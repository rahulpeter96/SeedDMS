<?php
//    MediaREPO. Document Management System
...
/**
 * @uses mediarepo_SQLiteFTS_Indexer
 */
require_once('SQLiteFTS/Indexer.php');

/**
 * @uses mediarepo_SQLiteFTS_Search
 */
require_once('SQLiteFTS/Search.php');

/**
 * @uses mediarepo_SQLiteFTS_Term
 */
require_once('SQLiteFTS/Term.php');

/**
 * @uses mediarepo_SQLiteFTS_QueryHit
 */
require_once('SQLiteFTS/QueryHit.php');

/**
 * @uses mediarepo_SQLiteFTS_IndexedDocument
 */
