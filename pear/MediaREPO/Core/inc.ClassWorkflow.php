...
class mediarepo_Core_Workflow { /* {{{ */
	...
	/**
	 * @var mediarepo_Core_Workflow_State initial state of the workflow
	 *
	 * @access protected
	 */
	var $_initstate;
	...
	/**
	 * @var mediarepo_Core_Workflow_Transition[] name of the workflow state
	 *
	 * @access protected
	 */
	var $_transitions;
	...
	/**
	 * @var mediarepo_Core_REPO reference to the repo instance this attribute belongs to
	 *
	 * @access protected
	 */
	var $_repo;
	...
	/**
	 * mediarepo_Core_Workflow constructor.
	 * @param int $id
	 * @param string $name
	 * @param mediarepo_Core_Workflow_State $initstate
	 */
	...
	/**
	 * @return mediarepo_Core_Workflow_State
	 */
	function getInitState() { return $this->_initstate; }

	/**
	 * @param mediarepo_Core_Workflow_State $state
	 * @return bool
	 */
	...
	/**
	 * @return mediarepo_Core_Workflow_Transition[]|bool
	 */
	function getTransitions() { /* {{{ */
		...
		for ($i = 0; $i < count($resArr); $i++) {
			$wkftransition = new mediarepo_Core_Workflow_Transition($resArr[$i]["id"], $this, $this->_repo->getWorkflowState($resArr[$i]["state"]), $this->_repo->getWorkflowAction($resArr[$i]["action"]), $this->_repo->getWorkflowState($resArr[$i]["nextstate"]), $resArr[$i]["maxtime"]);
			$wkftransition->setREPO($this->_repo);
	 ...
	 * @return bool|mediarepo_Core_Workflow_Transition
	 */
	 ...
	 *
	 * @param mediarepo_Core_Workflow_State $state current workflow state
	 * @return mediarepo_Core_Workflow_Transition[]|bool
	 */
	 ...
	 *
	 * @param mediarepo_Core_Workflow_State $state state to start from
	 * @param mediarepo_Core_Workflow_State $nextstate state after transition
	 * @return mediarepo_Core_Workflow_Transition[]|bool
	 */
	 ...
	 * Deprecated! User mediarepo_Core_Workflow_Transition::remove() instead.
	 *
	 * @param mediarepo_Core_Workflow_Transition $transition
	 ...
	 *
	 * @param mediarepo_Core_Workflow_State $state
	 * @param mediarepo_Core_Workflow_Action $action
	 * @param mediarepo_Core_Workflow_State $nextstate
	 * @param mediarepo_Core_User[] $users
	 * @param mediarepo_Core_Group[] $groups
	 * @return mediarepo_Core_Workflow_Transition|bool instance of new transition
	 */
	...
	/**
	 * @param mediarepo_Core_Workflow_State[] $laststates
	 * @return mediarepo_Core_Workflow_State[]|bool
	 */
 ...
 * @version    Release: 5.1.7
 */
class mediarepo_Core_Workflow_State { /* {{{ */
	/**
	...
	/**
	 * mediarepo_Core_Workflow_State constructor.
	 * @param $id
	 * @param $name
	 * @param $maxtime
	 * @param $precondfunc
	 ...
	 *
	 * @return mediarepo_Core_Workflow_Transition[]|boolean array of workflow transitions or false in case of an error
	 */
	function getTransitions() { /* {{{ */
		$db = $this->_repo->getDB();
		...
		$wkftransitions = array();
		for ($i = 0; $i < count($resArr); $i++) {
			$wkftransition = new mediarepo_Core_Workflow_Transition($resArr[$i]["id"], $this->_repo->getWorkflow($resArr[$i]["workflow"]), $this->_repo->getWorkflowState($resArr[$i]["state"]), $this->_repo->getWorkflowAction($resArr[$i]["action"]), $this->_repo->getWorkflowState($resArr[$i]["nextstate"]), $resArr[$i]["maxtime"]);
			$wkftransition->setREPO($this->_repo);
			$wkftransitions[$resArr[$i]["id"]] = $wkftransition;
		}
 ...
 * @version    Release: 5.1.7
 */
class mediarepo_Core_Workflow_Action { /* {{{ */
	/**
	...
	/**
	 * mediarepo_Core_Workflow_Action constructor.
	 * @param $id
	 * @param $name
	 */
 ...
 * @version    Release: 5.1.7
 */
class mediarepo_Core_Workflow_Transition { /* {{{ */
	/**
	...
	/**
	 * @var mediarepo_Core_Workflow workflow this transition belongs to
	 *
	 * @access protected
	 */
	var $_workflow;
	...
	/**
	 * @var mediarepo_Core_Workflow_State of the workflow transition
	 *
	 * @access protected
	 */
	var $_state;
	...
	/**
	 * @var mediarepo_Core_Workflow_State next state of the workflow transition
	 *
	 * @access protected
	 */
	var $_nextstate;
	...
	/**
	 * @var mediarepo_Core_Workflow_Action of the workflow transition
	 *
	 * @access protected
	 */
	var $_action;
	...
	/**
	 * @var mediarepo_Core_User[] of users allowed to trigger this transaction
	 *
	 * @access protected
	 */
	var $_users;
	...
	/**
	 * @var mediarepo_Core_Group[] of groups allowed to trigger this transaction
	 *
	 * @access protected
	 */
	var $_groups;
	...
	/**
	 * mediarepo_Core_Workflow_Transition constructor.
	 * @param $id
	 * @param $workflow
	 * @param $state
	 * @param $action
	...
	/**
	 * @return mediarepo_Core_Workflow
	 */
	function getWorkflow() { return $this->_workflow; }

	/**
	 * @param mediarepo_Core_Workflow $newWorkflow
	 * @return bool
	 */
	...
	/**
	 * @param mediarepo_Core_Workflow_State $newState
	 * @return bool
	 */
	...
	/**
	 * @param mediarepo_Core_Workflow_State $newNextState
	 * @return bool
	 */
	...
	/**
	 * @return mediarepo_Core_Workflow_Action
	 */
	function getAction() { return $this->_action; }

	/**
	 * @param mediarepo_Core_Workflow_Action $newAction
	 * @return bool
	 */
	 ...
	 *
	 * @return mediarepo_Core_User[]|bool list of users
	 */
	function getUsers() { /* {{{ */
		$db = $this->_repo->getDB();
		...
		$users = array();
		for ($i = 0; $i < count($resArr); $i++) {
			$user = new mediarepo_Core_Workflow_Transition_User($resArr[$i]['id'], $this, $this->_repo->getUser($resArr[$i]['userid']));
			$user->setREPO($this->_repo);
			$users[$i] = $user;
		}
	 ...
	 * Get all users allowed to trigger this transition
	 *
	 * @return mediarepo_Core_Group[]|bool list of users
	 */
	function getGroups() { /* {{{ */
		$db = $this->_repo->getDB();
		...
		$groups = array();
		for ($i = 0; $i < count($resArr); $i++) {
			$group = new mediarepo_Core_Workflow_Transition_Group($resArr[$i]['id'], $this, $this->_repo->getGroup($resArr[$i]['groupid']), $resArr[$i]['minusers']);
			$group->setREPO($this->_repo);
			$groups[$i] = $group;
		}
 ...
 * @version    Release: 5.1.7
 */
class mediarepo_Core_Workflow_Transition_User { /* {{{ */
	/**
	 * @var integer id of workflow transition
	 *
	 * @access protected
	...
	/**
	 * @var object reference to the repo instance this attribute belongs to
	...
	/**
	 * mediarepo_Core_Workflow_Transition_User constructor.
	 * @param $id
	 * @param $transition
	 * @param $user
	 */
 ...
 * @version    Release: 5.1.7
 */
class mediarepo_Core_Workflow_Transition_Group { /* {{{ */
	/**
	 * @var integer id of workflow transition
	 *
	 * @access protected
	...
	/**
	 * mediarepo_Core_Workflow_Transition_Group constructor.
	 * @param $id
	 * @param $transition
	 * @param $group
	 * @param $numOfUsers
 ...
 * @version    Release: 5.1.7
 */
class mediarepo_Core_Workflow_Log { /* {{{ */
	/**
	...
	/**
	 * mediarepo_Core_Workflow_Log constructor.
	 * @param $id
	 * @param $document
	 * @param $version
	 * @param $workflow
