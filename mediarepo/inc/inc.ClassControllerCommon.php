...
class mediarepo_Controller_Common {
	/**
	...
	function callHook($hook) { /* {{{ */
		...
		if(isset($GLOBALS['mediarepo_HOOKS']['controller'][lcfirst($tmp[2])])) {
			$r = null;
			foreach($GLOBALS['mediarepo_HOOKS']['controller'][lcfirst($tmp[2])] as $hookObj) {
