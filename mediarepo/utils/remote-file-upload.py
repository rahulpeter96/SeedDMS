...
def usage():
	...
	print
	print "The following shell variables can be set in ~/.mediarepo-upload.conf"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog="remove-file-upload", usage="Read a file from disk and upload it to mediarepo")
    ...
    d.set_background_title("Upload Mail into MediaREPO")
    if args.files:
