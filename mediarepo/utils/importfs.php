...
function usage() { /* {{{ */
	echo "Usage:\n";
	echo "  mediarepo-importfs [--config <file>] [-h] [-v] -F <folder id> -d <dirname>\n";
	echo "\n";
	echo "Description:\n";
	echo "  This program uploads a directory recursively into a folder of MediaREPO.\n";
	echo "\n";
	echo "Options:\n";
	echo "  -h, --help: print usage information and exit.\n";
	echo "  -v, --version: print version and exit.\n";
	echo "  --config: set alternative config file.\n";
	echo "  --user: use this user for accessing mediarepo.\n";
...
if(!($user = $repo->getUserByLogin($userlogin))) {
