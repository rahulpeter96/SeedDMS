...
$transition = $repo->getWorkflowTransition($_POST["transition"]);
...
if(isset($GLOBALS['mediarepo_HOOKS']['triggerWorkflowTransition'])) {
	foreach($GLOBALS['mediarepo_HOOKS']['triggerWorkflowTransition'] as $hookObj) {
