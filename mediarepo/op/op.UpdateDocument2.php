		...
		if (is_bool($contentResult) && !$contentResult) {
			...
			if($settings->_enableFullSearch) {
				...
				if($index) {
					...
					$index->addDocument(new $indexconf['IndexedDocument']($repo, $document, isset($settings->_converters['fulltext']) ? $settings->_converters['fulltext'] : null, !($filesize < $settings->_maxSizeForFullText)));
					$index->commit();
				}
			}
