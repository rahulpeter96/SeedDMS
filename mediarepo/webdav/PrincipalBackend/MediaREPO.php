...
namespace MediaREPO\PrincipalBackend;
 ...
 */
class MediaREPO extends \Sabre\DAVACL\PrincipalBackend\AbstractBackend implements \Sabre\DAVACL\PrincipalBackend\CreatePrincipalSupport {
    ...
    function getPrincipalByPath($path) {
        ...
        if(!($u = $this->repo->getUserByLogin($login)))
            return;
