...
namespace MediaREPO\CardDAV\Backend;
...
/**
 * MediaREPO CardDAV backend
 *
 * This CardDAV backend uses MediaREPO to store addressbooks
 *
 * @copyright Copyright (C) fruux GmbH (https://fruux.com/)
 * @author Evert Pot (http://evertpot.com/)
 * @license http://sabre.io/license/ Modified BSD License
 */
class MediaREPO extends \Sabre\CardDAV\Backend\AbstractBackend implements \Sabre\CardDAV\Backend\SyncSupport {
    ...
    function getCard($addressBookId, $cardUri) {
        ...
        if(!($u = $this->repo->getUserByLogin($cardUri)))
            return;
    ...
    function getMultipleCards($addressBookId, array $uris) {
        ...
        foreach($uris as $uri) {
            if($u = $this->repo->getUserByLogin($uri)) {
