 ...
 * @version    Release: @package_version@
 */
class mediarepo_View_DocumentVersionDetail extends mediarepo_Bootstrap_Style {
...
<?php
		...
		if ($file_exists) print "<li>". formatted_size(filesize($repo->contentDir . $version->getPath())) ." ".htmlspecialchars($version->getMimeType())."</li>";
		...
		$tmpfiles = mediarepo_Core_REPO::filterDocumentFiles($user, $tmpfiles);
