 ...
 * @version    Release: @package_version@
 */
class mediarepo_View_AddDocument extends mediarepo_Bootstrap_Style {
...
<?php
	$allUsers = $repo->getAllUsers($sortusersinlist);
...
<?php } ?>
<?php
			$attrdefs = $repo->getAllAttributeDefinitions(array(mediarepo_Core_AttributeDefinition::objtype_document, mediarepo_Core_AttributeDefinition::objtype_all));
			if($attrdefs) {
