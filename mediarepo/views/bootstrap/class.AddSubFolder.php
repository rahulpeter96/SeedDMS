 ...
 * @version    Release: @package_version@
 */
class mediarepo_View_AddSubFolder extends mediarepo_Bootstrap_Style {
...
<?php
	$attrdefs = $repo->getAllAttributeDefinitions(array(mediarepo_Core_AttributeDefinition::objtype_folder, mediarepo_Core_AttributeDefinition::objtype_all));
	if($attrdefs) {
