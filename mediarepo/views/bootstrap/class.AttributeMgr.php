 ...
 * @version    Release: @package_version@
 */
class mediarepo_View_AttributeMgr extends mediarepo_Bootstrap_Style {
	...
	function info() { /* {{{ */
		...
		if($selattrdef) {
			...
			if($res['folders'] || $res['docs']) {
				...
				$previewer = new mediarepo_Preview_Previewer($cachedir, $previewwidth, $timeout);
...
?>
					...
					<div class="control-group">
						...
						<div class="controls">
						<select name="objtype"><option value="<?php echo mediarepo_Core_AttributeDefinition::objtype_all ?>"><?php printMLText('all'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::objtype_folder ?>" <?php if($attrdef && $attrdef->getObjType() == mediarepo_Core_AttributeDefinition::objtype_folder) echo "selected"; ?>><?php printMLText('folder'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::objtype_document ?>" <?php if($attrdef && $attrdef->getObjType() == mediarepo_Core_AttributeDefinition::objtype_document) echo "selected"; ?>><?php printMLText('document'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::objtype_documentcontent ?>" <?php if($attrdef && $attrdef->getObjType() == mediarepo_Core_AttributeDefinition::objtype_documentcontent) echo "selected"; ?>><?php printMLText('documentcontent'); ?></option></select>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<select name="type"><option value="<?php echo mediarepo_Core_AttributeDefinition::type_int ?>" <?php if($attrdef && $attrdef->getType() == mediarepo_Core_AttributeDefinition::type_int) echo "selected"; ?>><?php printMLText('attrdef_type_int'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::type_float ?>" <?php if($attrdef && $attrdef->getType() == mediarepo_Core_AttributeDefinition::type_float) echo "selected"; ?>><?php printMLText('attrdef_type_float'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::type_string ?>" <?php if($attrdef && $attrdef->getType() == mediarepo_Core_AttributeDefinition::type_string) echo "selected"; ?>><?php printMLText('attrdef_type_string'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::type_boolean ?>" <?php if($attrdef && $attrdef->getType() == mediarepo_Core_AttributeDefinition::type_boolean) echo "selected"; ?>><?php printMLText('attrdef_type_boolean'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::type_date ?>" <?php if($attrdef && $attrdef->getType() == mediarepo_Core_AttributeDefinition::type_date) echo "selected"; ?>><?php printMLText('attrdef_type_date'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::type_email ?>" <?php if($attrdef && $attrdef->getType() == mediarepo_Core_AttributeDefinition::type_email) echo "selected"; ?>><?php printMLText('attrdef_type_email'); ?></option><option value="<?php echo mediarepo_Core_AttributeDefinition::type_url ?>" <?php if($attrdef && $attrdef->getType() == mediarepo_Core_AttributeDefinition::type_url) echo "selected"; ?>><?php printMLText('attrdef_type_url'); ?></option></select>
						</div>
					</div>
		...
		if($attrdefs) {
			foreach ($attrdefs as $attrdef) {
				switch($attrdef->getObjType()) {
					case mediarepo_Core_AttributeDefinition::objtype_all:
						$ot = getMLText("all");
						break;
					case mediarepo_Core_AttributeDefinition::objtype_folder:
						$ot = getMLText("folder");
						break;
					case mediarepo_Core_AttributeDefinition::objtype_document:
						$ot = getMLText("document");
						break;
					case mediarepo_Core_AttributeDefinition::objtype_documentcontent:
						$ot = getMLText("documentcontent");
						break;
				}
				switch($attrdef->getType()) {
					case mediarepo_Core_AttributeDefinition::type_int:
						$t = getMLText("attrdef_type_int");
						break;
					case mediarepo_Core_AttributeDefinition::type_float:
						$t = getMLText("attrdef_type_float");
						break;
					case mediarepo_Core_AttributeDefinition::type_string:
						$t = getMLText("attrdef_type_string");
						break;
					case mediarepo_Core_AttributeDefinition::type_date:
