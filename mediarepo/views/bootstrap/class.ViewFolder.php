 ...
 * @version    Release: @package_version@
 */
class mediarepo_View_ViewFolder extends mediarepo_Bootstrap_Style {
...
//	var limit = element.data('limit')
	url = mediarepo_webroot+"out/out.ViewFolder.php?action=entries&folderid="+folder+"&offset="+offset+"&limit="+limit<?= $orderby ? '+"&orderby='.$orderby.'"' : "" ?>;
	$.ajax({
		type: 'GET',
		url: url,
		dataType: 'json',
...
<?php
		...
		if ($enableDropUpload && $folder->getAccessMode($user) >= M_READWRITE) {
			echo "mediarepoUpload.setUrl('../op/op.Ajax.php');";
			echo "mediarepoUpload.setAbortBtnLabel('".getMLText("cancel")."');";
			echo "mediarepoUpload.setEditBtnLabel('".getMLText("edit_document_props")."');";
			echo "mediarepoUpload.setMaxFileSize(".mediarepo_Core_File::parse_filesize(ini_get("upload_max_filesize")).");";
			echo "mediarepoUpload.setMaxFileSizeMsg('".getMLText("uploading_maxsize")."');";
		}
...
//			$this->addFooterJS("mediarepoUpload.setUrl('../op/op.Ajax.php');");
//			$this->addFooterJS("mediarepoUpload.setAbortBtnLabel('".getMLText("cancel")."');");
//			$this->addFooterJS("mediarepoUpload.setEditBtnLabel('".getMLText("edit_document_props")."');");
//			$this->addFooterJS("mediarepoUpload.setMaxFileSize(".mediarepo_Core_File::parse_filesize(ini_get("upload_max_filesize")).");");
//			$this->addFooterJS("mediarepoUpload.setMaxFileSizeMsg('".getMLText("uploading_maxsize")."');");
?>
